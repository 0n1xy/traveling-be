...
router.post('/', authenticateFirebase, uploadPostImg.array('images', 10), createTravelPost);
...
router.put('/:id', authenticateFirebase, uploadPostImg.array('images', 10), updateTravelPost);
